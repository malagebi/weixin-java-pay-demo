...
public class WxPayController {
    ...
    public WxPayOrderQueryResult queryOrder(@RequestParam(required = false) String transactionId,
        ...
        WxMpConfigStorage store = new WxMpInMemoryConfigStorage();
        ((WxMpInMemoryConfigStorage) store).setAppId("");
        wxMpService.setWxMpConfigStorage(store);

        wxcpService.getOauth2Service().buildAuthorizationUrl(null);
        try {
            wxcpService.getOauth2Service().getUserInfo("asd");
